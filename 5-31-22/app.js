/*Create a method all which takes two params:a sequence a function (function pointer in C)
...
function all( arr, fun ){
  ...
  }  //test every element to the provided function